...
func TestTypeContainer_MapUnordered(t *testing.T) {
	var err error
	is := require.New(t)
	withProtocols(t, defaultTestTProtocols, nil, func(protofactory thrift.TProtocolFactory) {
		withBytesTTransport(t, func(b *bytes.Buffer, trans thrift.TTransport) {
			...
			typ := NewTypeContainerMapUnordered[int64, int64](TypeContainerDesc{thrift.I64, thrift.I64}, true)
